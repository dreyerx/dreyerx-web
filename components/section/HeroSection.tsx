...
export default function HeroAction(props: { ref: any }) {
    return (
        <Flex ref={[props.ref]} height={['120vh', '100vh']} justify={'center'} align={'center'} backgroundImage={'url("assets/images/dreyerx-hero-bg.svg")'} backgroundSize={['cover', 'cover']} backgroundPosition={['bottom 0px center', '', '']} backgroundRepeat={'no-repeat'}>
