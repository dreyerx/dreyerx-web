...
export default function FooterSection() {
  ...
  return (
    <Flex width={'full'} flexDirection={'column'} bgColor={'footer'} p={[10, 10, '60px']} bottom={0} py={20}>
      <Box mx={[0, 0, 20]}>
        <Flex align={'start'} justify={'space-between'} flexDirection={['column', 'column', 'row']} gap={[10, 10, 0]}>
          <Flex flexDirection={['column', 'column']} w={['full', 'full', '500px']} gap={5}>
          ...
          <Flex gap={[10, 10, 90]} flexDirection={['column', 'column', 'row']}>
            {
